...
const items = [
  { to: '/lecturer/overview', label: 'Overview' },
  { to: '/lecturer/session-requests', label: 'Requests' },
  { to: '/lecturer/mentees', label: 'Mentees' },
  { to: '/lecturer/availability', label: 'Availability' },
  { to: '/lecturer/resource-upload', label: 'Upload' },
  { to: '/lecturer/analytics', label: 'Analytics' },
  { to: '/lecturer/messages', label: 'Messages' },
];

const LecturerTopNav: React.FC = () => {
